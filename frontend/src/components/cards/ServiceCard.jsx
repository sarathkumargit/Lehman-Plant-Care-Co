...
export default function ServiceCard({ service, className }) {
  return (
    <div
      className={cn('group relative p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl', className)}
    ...
    >
      ...
      <div className="relative">
        <span className="text-3xl font-mono" style={{ color: 'var(--color-primary)' }}>{service.icon}</span>
